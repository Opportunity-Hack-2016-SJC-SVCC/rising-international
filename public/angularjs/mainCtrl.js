...
//		    	            format: function (d, ratio) { return ""; }
		...
		/*var init = function(){
		    makeGauge('#accessories', 12, '#1abc9c');
		    makeGauge('#apparels', 22, '#3498db');
		    //makeGauge('#d1-c3', 30, '#f39c12');
		};*/
		 ...
		 var makeGauge = function(selector, value, color)
			...
			makeGauge('#kids', 15, '#f39c12');
			makeGauge('#housewares', 20, '#1abc9c');
			...
			c3.generate({
				...
				columns: [
				    ...
				    ['Your monthly earnings', 30, 200, 100, 400, 150, 250, 30, 200, 112, 322, 70, 300]
				],
				//type: 'spline'
				type: type
			    },
